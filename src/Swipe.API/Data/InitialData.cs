        ...
        public static void Seed(this SwipeDBContext dbContext)
        {
                ...
                if (!dbContext.Posts.Any())
            {
                ...
                dbContext.Posts.Add(new Post
                {
                    ...
                    ImageUrl =
                        "https://i1.wp.com/thebrokentest.com/wp-content/uploads/2020/03/IMG_3345.jpeg?w=1536&ssl=1",
                 //   Tags = new Tag[] { Tag.SoftwareCraftmanship },
                    IntroducedAt = DateTimeOffset.Now,
                    Opened = 1,
                    Ignored = 4
                });
                ...
                dbContext.Posts.Add(new Post
                {
                    ...
                    ImageUrl =
                        "https://i1.wp.com/thebrokentest.com/wp-content/uploads/2020/03/IMG_3345.jpeg?w=1536&ssl=1",
                    //   Tags = new Tag[] { Tag.SoftwareCraftmanship, Tag.Automation },
                    IntroducedAt = DateTimeOffset.Now,
                    Opened = 15,
                    Ignored = 1
                });
                ...
                if (!dbContext.TagPostMaps.Any())
                {
                    dbContext.TagPostMaps.Add(new API.Data.TagPostMap
                    {
                        ProductId = 1,
                        TagId = 3
